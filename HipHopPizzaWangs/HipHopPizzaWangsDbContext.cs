...
public class HipHopPizzaWangsDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Order>().HasData(new Order[]
            { 
                new Order { Id = 1, CustomerName = "Dustin", CustomerEmail = "demoney@gmail.com", CustomerPhoneNumber = "9312613939", UserId = "1", PaymentTypeId = 1, IsOpen = false, OrderTotal = 123, Feedback = false, Tip = 12, OrderType = "Call in", ItemId = 1, OrderTotalWithoutTip = 25},
                new Order { Id = 2, CustomerName = "Dustin", CustomerEmail = "demoney@gmail.com", CustomerPhoneNumber = "9312613939", UserId = "2", PaymentTypeId = 2, IsOpen = true, OrderTotal = 123, Feedback = true, Tip = 12, OrderType = "Take Out", ItemId = 2, OrderTotalWithoutTip = 2},
                new Order { Id = 3, CustomerName = "Dustin", CustomerEmail = "demoney@gmail.com", CustomerPhoneNumber = "9312613939", UserId = "3", PaymentTypeId = 3, IsOpen = true, OrderTotal = 123, Feedback = false, Tip = 12, OrderType = "Dine In", ItemId = 3, OrderTotalWithoutTip = 2},
                });
    }
    };